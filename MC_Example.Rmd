...
<<<<<<< HEAD:MC_Example.Rmd
Additional clarity on the expected net benefits of interventions could be gained by collecting information on these important variables. 
=======
...
>>>>>>> 74285a735171bec9215183c3058563a8bb60eeba:Burkina_vignette.Rmd
...
More information on all these outputs are contained in the ```decisionSupport``` manual, especially under ```welfareDecisionAnalysis``` [@R-decisionSupport].
